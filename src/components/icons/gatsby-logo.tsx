...
export const GatsbyLogo = ({ className }: LogoProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" role="img" className={className}>
            <title>Gatsby</title>
            <desc>Gatsby Framework Logo</desc>
            <path
                fill="currentColor"
