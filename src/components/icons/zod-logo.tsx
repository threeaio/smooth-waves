...
export const ZodLogo = (props: LogoProps) => {
  ...
  return (
    ...
    >
      <title>Zod</title>
      <desc>Zod Schema Validation Library Logo</desc>
      <defs>
        <filter
          id="zod-shadow"
          width="105.2%"
      ...
      <g>
        ...
        <g transform="translate(2 1.51)">
          <use href="#zod-path" filter="url(#zod-shadow)" />
          <use href="#zod-path" fill="currentColor" />
        </g>
      </g>
    </svg>
  );
