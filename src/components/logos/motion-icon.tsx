...
export const MOTION_YELLOW = '#FFF312';

export const MotionIcon: React.FC<GitHubIconProps> = ({ className = '', ...props }) => {
    return (
        <svg viewBox="0 0 1103 386" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
            <path
                fill="currentColor"
