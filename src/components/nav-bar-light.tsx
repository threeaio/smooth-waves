...
export function NavBarLight() {
    ...
    return (
        <nav
            className={cn(
                'fixed top-0 left-0 right-0 z-50 bg-gradient-to-t from-ui-gradient-bottom/90 to-ui-gradient-top/100 backdrop-blur-sm md:backdrop-blur-none md:bg-none overflow-hidden',
        ...
        >
            <div
                ...
                style={{
                    background: 'radial-gradient(ellipse at center, var(--site-glow-violet) 0%, transparent 70%)',
                }}
            />
                ...
                <div className="flex gap-2 sm:gap-4 md:gap-8">
                    {links.map((link) => (
                        <Link
                            ...
                            href={link.href}
                            className={cn(
                                'transition-colors text-xs uppercase p-2',
